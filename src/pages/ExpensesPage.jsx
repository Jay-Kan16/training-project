      ...
      <Card className="p-5">
        <div className="flex items-center justify-between mb-4 flex-wrap gap-3">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-0.5">Track all your shared expenses.</p>
          </div>
          <button
        ...
        {overviewLoading && filtered.length === 0 ? (
          ...
          <p className="text-sm text-gray-500 py-8 text-center">No expenses match these filters.</p>
        ) : (
          <ul className="divide-y divide-gray-100">
            {filtered.map((exp) => {
              ...
              return (
                <li key={exp._id} className="py-3.5 flex items-center justify-between">
                  ...
                  <div className="text-right shrink-0 pl-3">
                    ...
                    <p className="text-xs text-gray-400">
                      {paidByMe ? (
                        ...
                        <>
                          Paid by <span className="text-primary-600">{exp.payer?.name}</span>
                        </>
                      )}
                    </p>
                  </div>
