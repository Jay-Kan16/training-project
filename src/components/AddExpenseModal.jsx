      ...
      <div className="relative bg-white w-full max-w-md rounded-2xl shadow-xl max-h-[90vh] overflow-y-auto p-6">
        ...
        <form onSubmit={submitExpense} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full border border-gray-200 rounded-lg pl-7 pr-3 py-2.5 text-sm"
              />
            </div>
          </div>
          ...
          <button
            ...
            className="w-full bg-primary-600 hover:bg-primary-700 disabled:opacity-50 text-white font-semibold text-sm py-3 rounded-lg"
          >
